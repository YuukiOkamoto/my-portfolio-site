...
👍 <ExternalLink href='https://5ecbc5922051330006304152--blog-using-novela-theme.netlify.app/'>Demo</ExternalLink>

👍 <ExternalLink href='https://github.com/YuukiOkamoto/blog-using-novela-theme/tree/config-site'>ソースコード(GitHub)</ExternalLink>
...
<Collapse>
<>gatsby-cliをインストールしていない方</>

gatsby-cliをインストールしていない方は以下のコマンドでインストールしてください！
...
```jsx title=@narative/gatsby-theme-novela/src/components/Logo/Logo.tsx
...
```jsx title=src/@narative/gatsby-theme-novela/components/Logo/Logo.js
import React from 'react';
...
```jsx line={16,42,59} title=@narative/gatsby-theme-novela/src/components/Navigation/Navigation.Footer.tsx
import React from 'react';
import styled from '@emotion/styled';
import { graphql, useStaticQuery } from 'gatsby';
...
```jsx line={17-20,42,62} title=@narative/gatsby-theme-novela/src/components/Navigation/Navigation.Footer.tsx
import React from 'react';
import styled from '@emotion/styled';
import { graphql, useStaticQuery } from 'gatsby';
