...
<PostLink to='/blog/what-is-themes/' />
...
```jsx title=gatsby-theme-blog/src/components/bio-content.js collapse=テーマのbio-content.js全文
...
```jsx title=src/gatsby-theme-blog/components/bio-content.js collapse=自サイトのbio-content.js全文
...
```jsx title=gatsby-theme-blog/src/components/bio.js collapse=テーマのbio.js全文
/**
...
```jsx title=src/gatsby-theme-blog/components/bio.js collapse=自サイトのbio.js全文
import React from 'react';
import { useStaticQuery, graphql } from 'gatsby';
import Image from 'gatsby-image';
import { Styled, css, Flex } from 'theme-ui';
